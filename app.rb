...
dud.say 'Hi there, my name is #{dude.first_name}!'

dude. say "I'm only #{dude.age} years old."

dude.say "That's right, I was born in #{dude.birthyear}"

dudde.say "My favorite color is ... " + color = %w(red orange yellow green blue purple black white)

dude.say color

dude.sy "oh, and my favorite number is " + rand
